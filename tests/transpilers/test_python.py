...
def test_float64() -> None:
    """Test astx.Float64."""
    # Variable declaration
    float64_var = astx.VariableAssignment(
        name="x",
        value=astx.LiteralFloat64(10.5),
        loc=astx.SourceLocation(line=1, col=0),
    )
    ...
    binary_op = astx.BinaryOp(
        op_code="+",
        lhs=astx.Variable(name="x"),
        rhs=astx.LiteralFloat64(5.5),
        loc=astx.SourceLocation(line=2, col=4),
    )

    # Function body
    body = astx.Block()
    body.append(float64_var)
    body.append(binary_op)

    # Function definition
    add_float64_function = astx.Function(
        prototype=astx.FunctionPrototype(
            name="add_float64",
            args=astx.Arguments(),
...
def test_float16() -> None:
    """Test astx.Float16."""
    # Variable declaration
    float16_var = astx.VariableAssignment(
        name="x",
        value=astx.LiteralFloat16(10.5),
        loc=astx.SourceLocation(line=1, col=0),
    )
    ...
    binary_op = astx.BinaryOp(
        op_code="+",
        lhs=astx.Variable(name="x"),
        rhs=astx.LiteralFloat16(5.5),
        loc=astx.SourceLocation(line=2, col=4),
    )

    # Function body
    body = astx.Block()
    body.append(float16_var)
    body.append(binary_op)

    # Function definition
    add_float16_function = astx.Function(
        prototype=astx.FunctionPrototype(
            name="add_float16",
            args=astx.Arguments(),
            return_type=astx.Float16,
        ),
        body=body,
        loc=astx.SourceLocation(line=1, col=0),
    )
